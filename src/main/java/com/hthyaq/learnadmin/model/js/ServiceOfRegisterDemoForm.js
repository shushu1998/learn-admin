...
type: {type: "string", required: true, message: '机构类型不能为空'},
email: {type: "string", required: true, message: '电子邮箱不能为空'},
mobile: {type: "string", required: true, message: '手机号码不能为空'},

}
class ServiceOfRegisterDemoForm extends PureComponent {
 state = {}
 constructor(props) {
  super(props);
...
componentWillMount() {
 ...
 <FormItem label="机构类型" name="type"><Input/></FormItem>
...
export default ServiceOfRegisterDemoForm
